                                    ...
                                    <div class="form-body">
                                        <form class="row g-3">
                                            <div class="col-12">
                                                ...
                                                <input type="email" value="admin@gmail.com" class="form-control" id="inputEmailAddress" placeholder="Email Address">
                                            </div>
                                            <div class="col-12">
                                            ...
                                            <div class="col-12">
                                                <div class="d-grid">
                                                    ...
                                                    <button type="submit" class="btn btn-primary"><i class="bx bxs-lock-open"></i>
